      ...
      <main>
        ...
        <section id="contact" className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="mb-4">Ready to see how FPV can unlock new possibilities for your operations?</p>
                <div className="flex items-center space-x-2 mb-2">
                  <Mail className="h-5 w-5 text-orange-500" />
                  <span>justin@needfpv.com</span>
                </div>
                <div className="flex items-center space-x-2 mb-2">
                  <Phone className="h-5 w-5 text-orange-500" />
                  <span>502-724-0878</span>
                </div>
        ...
        <section className="py-16 bg-gray-900">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-8">Security and Compliance</h2>
            <p className="text-lg">
              All consultations and services are conducted with strict adherence to security protocols and best practices, ensuring that sensitive data and operations remain protected.
            </p>
          </div>
        </section>
      </main>
